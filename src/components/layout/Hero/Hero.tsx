...
export default function Hero() {
  return (
    ...
    >
      <div className="bg-boxdark/50 min-h-screen pt-[150px]">
        <Container>
          <div>
            <div className="text-white text-center">
              <h1 className="text-8xl text-secondary font-indie-flower mt-16">
                BlogoSphere
              </h1>
              <h2 className="text-3xl my-8">
                Your world of ideas,{" "}
                <span className="text-meta-6 text-4xl font-semibold font-mono uppercase">
                  Unbound
                </span>
              </h2>
