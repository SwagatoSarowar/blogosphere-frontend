...
export default function Sidebar({ sidebarOpen, setSidebarOpen }: SidebarProps) {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-transparent backdrop-blur-lg duration-300 ease-linear lg:shadow-[4px_0px_4px_0px_rgba(0,0,0,0.25)] md:hidden ${
